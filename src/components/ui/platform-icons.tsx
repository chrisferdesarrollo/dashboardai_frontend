...
export const WhatsAppIcon: React.FC<IconProps> = ({ className = '', size }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    className={className}
    style={!size ? { width: '100%', height: '100%' } : undefined}
  >
    <defs>
...
export const TelegramIcon: React.FC<IconProps> = ({ className = '', size }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
